 ...
 * @author Peter Cross
 */
public class DynamicDimensions extends Stage implements Constants
{
    /*
        Attributes
    */
    ...
    private String          title = "G/L Account Dimensions";
    private AssociativeList attributesList;
    
    private GLAccount       glAccount;
    private TableElement[]  table;
    private AssociativeList initValue;
    private String[]        init;
    ...
    */
    ...
    /**
     * Displays G/L dimensions input dialogue
     */
    ...
    protected void createComboBox( GridPane grid, String analytics, int col, int row )
    {
        ...
        try
        {
            cls = createDataClass( dimension.get( analytics ) );   
        }
        catch ( Exception e ) {}
    ...
    */
     ...
     */
    public DynamicDimensions( GLAccount account, Stage stage, String initValue )
    {
