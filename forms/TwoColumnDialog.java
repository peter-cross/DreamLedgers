 ...
 * @author Peter Cross
 */
public class TwoColumnDialog extends OneColumnDialog
{
    /**
    ...
    public TwoColumnDialog( RegistryItem doc, String title )
    {
        super( doc, title );
    }
    
    public TwoColumnDialog( Stage form, String title, String[] tabs, DialogElement[]... dlg )
    {
        super( form, title, tabs, dlg );
    }
} // End of class ** TwoColumnDialog **